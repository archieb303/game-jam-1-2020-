...
public class bird_bois_creator extends PApplet {
...
public void display(int eyes, int plumage, int beak, int feet, int pattern, int wings) { //drawing the bird
  tint(r,g,b);
...
public void keyPressed() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "bird_bois_creator" };
    if (passedArgs != null) {
